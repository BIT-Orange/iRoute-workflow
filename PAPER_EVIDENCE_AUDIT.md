...
| `figs/fig5_recovery_churn.pdf` | present and traceable | Published provenance exists at `results/figures/fig5_recovery_churn.paper_grade.figure.json`, backed by `results/aggregates/fig5-failure-paper-grade-final-20260311d/`. |
| `figs/fig5_recovery_link-fail.pdf` | present and traceable | Published provenance exists at `results/figures/fig5_recovery_link-fail.paper_grade.figure.json`, backed by `results/aggregates/fig5-failure-paper-grade-final-20260311d/`. |
| `figs/fig5_recovery_domain-fail.pdf` | present and traceable | Published provenance exists at `results/figures/fig5_recovery_domain-fail.paper_grade.figure.json`, backed by `results/aggregates/fig5-failure-paper-grade-final-20260311d/`. |
...
- Canonical published provenance now exists for Fig. 1, Fig. 2, and Fig. 5 under `results/figures/*.paper_grade.figure.json`.
- Canonical partial provenance now exists for Fig. 3 and Fig. 4 under `results/figures/*.paper_grade.figure.json`.
...
- Fig. 3/4 remain non-publishable because the paper-facing `paper/figs/` files are still absent.
