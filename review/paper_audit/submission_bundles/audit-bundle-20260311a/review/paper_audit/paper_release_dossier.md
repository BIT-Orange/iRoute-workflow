...
Generated at: `2026-03-11T08:45:01.528270+00:00`
...
- `figs/mermaid.png` [blocked] reason=`source_missing` management=`manual` source_kind=`source_managed_slot` output_exists=`False`
- `figs/system-arch.pdf` [blocked] reason=`source_missing` management=`manual` source_kind=`source_managed_slot` output_exists=`False`

## Missing Paper-Facing References

- `figs/system-arch.pdf` [manual_asset] -> `paper/figs/system-arch.pdf` (asset_status=blocked, status_reason=source_missing)
- `figs/mermaid.png` [manual_asset] -> `paper/figs/mermaid.png` (asset_status=blocked, status_reason=source_missing)
