...
|                 | etc.                                                                |
+-----------------+---------------------------------------------------------------------+
| ``extensions/`` | iRoute semantic routing protocol implementation including           |
|                 | :iroute:`SemanticVector`, :iroute:`RouteManager`,                   |
|                 | :iroute:`SemanticStrategy`. See :doc:`iroute` for details.          |
+-----------------+---------------------------------------------------------------------+
