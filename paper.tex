...
% Edit paper/main.tex instead of this file.
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/system-arch.pdf}
...
We compare \sysname{} against three implementable baselines that bracket the design space.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.92\linewidth]{figures/fig1_accuracy_overhead.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.92\linewidth]{figures/fig2_retrieval_cdf.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.92\linewidth]{figures/fig3_hop_load.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.92\linewidth]{figures/fig4_state_scaling.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/fig5_recovery_churn.pdf}
        \caption{Churn}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/fig5_recovery_link-fail.pdf}
        \caption{Link failure}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/fig5_recovery_domain-fail.pdf}
